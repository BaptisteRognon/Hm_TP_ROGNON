...
const SUPABASE_URL = 'https://fsqasordbaiwjmdtodlt.supabase.co'
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZzcWFzb3JkYmFpd2ptZHRvZGx0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NjM1OTU3NjMsImV4cCI6MTk3OTE3MTc2M30.ovp7OaYpbtJ2Ky0s5PkGGyf32cZfz-ggGHoibckkvaQ'
  ...
  methods: {  
    ...
    async register(){ 
      try { 
        ...
        document.getElementById('status').innerHTML='Please validate the received email !'} catch (error) { 
